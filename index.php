<?php
include("./Student_interface/Functions/script.php");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="./Student_interface/login-style.css">
...
<body>
    <div class="login-container">
        ...
        <form method="POST"> <!-- Action to the login processing script -->
